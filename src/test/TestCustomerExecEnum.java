...
public class TestCustomerExecEnum {
    public static void main(String[] args) {
        ...
        try {
            start = dateFormat2.parse("06/07/2018 19:00");
            end = dateFormat2.parse("06/07/2018 20:30");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        ...
        //proxy.addAssignment("ERICA.ROSSI@GMAIL.COM", start, end, selectedDogs, new Address("ITALY", "GENOVA", "VIA DEL PORTO", "1", "16121"), true);
